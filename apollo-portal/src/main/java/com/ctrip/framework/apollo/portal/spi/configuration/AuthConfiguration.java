...
public class AuthConfiguration {
  ...
  static class SpringSecurityAuthAutoConfiguration {
    ...
    public JdbcUserDetailsManager jdbcUserDetailsManager(AuthenticationManagerBuilder auth,
      ...
      jdbcUserDetailsManager
          .setUpdateUserSql("update \"Users\" set \"Password\" = ?, \"Enabled\" = ? where \"Id\" = (select \"Id\" from \"Users\" where \"Username\" = ?)");
      jdbcUserDetailsManager.setDeleteUserSql("delete from \"Users\" where \"Id\" = (select \"Id\" from \"Users\" where \"Username\" = ?)");
      jdbcUserDetailsManager
          .setCreateAuthoritySql("insert into \"Authorities\" (\"Username\", \"Authority\") values (?,?)");
      jdbcUserDetailsManager
          .setDeleteUserAuthoritiesSql("delete from \"Authorities\" where \"Id\" = (select \"Id\" from \"Users\" where \"Username\" = ?)");
      jdbcUserDetailsManager
          .setChangePasswordSql("update \"Users\" set \"Password\" = ? where \"Id\" = (select \"Id\" from \"Users\" where \"Username\" = ?)");
